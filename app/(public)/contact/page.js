  ...
  return (
    <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="border border-slate-100 rounded-xl p-6 bg-slate-50/50 hover:border-brand-200 hover:shadow-md transition-all duration-300 group">
          ...
          <a href="https://wa.me/201556299599" dir="ltr" className="text-brand-700 text-lg font-bold hover:underline inline-flex items-center gap-2">
            <span dir="ltr">01556299599</span>
          </a>
        </div>

        <div className="border border-slate-100 rounded-xl p-6 bg-slate-50/50 hover:border-brand-200 hover:shadow-md transition-all duration-300 group">
          <div className="h-12 w-12 bg-brand-100 text-brand-700 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
          ...
          <a href="mailto:ramadanmahdy45@gmail.com" className="text-brand-700 text-base font-bold hover:underline inline-flex items-center gap-2 break-all">
