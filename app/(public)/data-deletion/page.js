export const metadata = {
  title: 'حذف البيانات - BankReach',
};

export default function DataDeletionPage() {
  return (
    <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-200">
      <h1 className="text-3xl font-bold mb-6 text-slate-900">تعليمات حذف البيانات</h1>
      ...
      <div className="space-y-6 text-slate-700 leading-relaxed">
        ...
        <p className="text-sm text-slate-500 mt-4">
          سيتم مراجعة طلبك وحذف بياناتك بشكل دائم من أنظمتنا خلال مدة أقصاها 7 أيام عمل من تاريخ استلام الطلب. سنقوم بإرسال رسالة تأكيد بمجرد إتمام عملية الحذف.
        </p>
      </div>
    </div>
  );
