  ...
  return (
    <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-200">
      ...
      <div className="space-y-6 text-slate-700 leading-relaxed">
        ...
        <div>
          <h2 className="text-xl font-bold mb-3 text-blue-800">1. التزامات المستخدم</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-bold mb-3 text-blue-800">2. حقوق الملكية</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-bold mb-3 text-blue-800">3. إخلاء المسؤولية</h2>
          <p>
